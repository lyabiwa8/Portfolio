    ...
    <section id="about" className="py-24 px-6 bg-transparent relative z-10">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <h2 className="text-sm uppercase tracking-widest text-[#9F1239] font-semibold mb-4">À mon sujet</h2>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
              <span className="block text-2xl font-display font-bold text-white">BTS</span>
              <span className="text-sm text-white/40 uppercase tracking-wide">Communication</span>
            </div>
            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
              <span className="block text-2xl font-display font-bold text-white">C1</span>
              <span className="text-sm text-white/40 uppercase tracking-wide">Niveau Anglais</span>
            </div>
          </div>
        </motion.div>
      </div>
